...
static ItemRow rItemTable[] = {
    ...
    [GI_SHIELD_DEKU]        = ITEM_ROW(0x53, CHEST_JUNK,      0x3E, 0x004C,   0x00CB, 0x00, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_Shield, 1, -1), // Deku Shield
    [GI_SHIELD_HYLIAN]      = ITEM_ROW(0x53, CHEST_JUNK,      0x3F, 0x004D,   0x00DC, 0x00, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_Shield, 2, -1), // Hylian Shield
    ...
    [GI_SOUL_ANUBIS]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9467,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_ANUBIS,                -1), // Anubis Soul
    [GI_SOUL_SPIKE]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9468,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SPIKE,                 -1), // Spike Soul
    [GI_SOUL_SKULL_KID]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9469,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SKULL_KID,             -1), // Skull Kid Soul
    [GI_SOUL_FREEZARD]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946A,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FREEZARD,              -1), // Freezard Soul
    [GI_SOUL_DEKU_SCRUB]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946B,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DEKU_SCRUB,            -1), // Deku Scrub Soul
    [GI_SOUL_WOLFOS]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946C,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_WOLFOS,                -1), // Wolfos Soul
    [GI_SOUL_STALCHILD]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946D,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_STALCHILD,             -1), // Stalchild Soul
    [GI_SOUL_GUAY]          = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946E,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GUAY,                  -1), // Guay Soul
    [GI_SOUL_DOOR_MIMIC]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946F,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DOOR_MIMIC,            -1), // Door Mimic Soul
    [GI_SOUL_STALFOS]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9470,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_STALFOS,               -1), // Stalfos Soul
    [GI_SOUL_DARK_LINK]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9471,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DARK_LINK,             -1), // Dark Link Soul
    [GI_SOUL_FLARE_DANCER]  = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9472,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FLARE_DANCER,          -1), // Flare Dancer Soul
    [GI_SOUL_DEAD_HAND]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9473,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DEAD_HAND,             -1), // Dead Hand Soul
    [GI_SOUL_GERUDO]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9474,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GERUDO,                -1), // Gerudo Soul
    [GI_SOUL_GOHMA]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9475,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GOHMA,                 -1), // Gohma Soul
    [GI_SOUL_DODONGO]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9476,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DODONGO,               -1), // Dodongo Soul
    [GI_SOUL_BARINADE]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9477,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BARINADE,              -1), // Barinade Soul
    [GI_SOUL_PHANTOM_GANON] = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9478,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_PHANTOM_GANON,         -1), // Phantom Ganon Soul
    [GI_SOUL_VOLVAGIA]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9479,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_VOLVAGIA,              -1), // Volvagia Soul
    [GI_SOUL_MORPHA]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947A,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_MORPHA,                -1), // Morpha Soul
    [GI_SOUL_BONGO_BONGO]   = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947B,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BONGO_BONGO,           -1), // Bongo Bongo Soul
    [GI_SOUL_TWINROVA]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947C,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_TWINROVA,              -1), // Twinrova Soul
    [GI_SOUL_GANON]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947D,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GANON,                 -1), // Ganon Soul
