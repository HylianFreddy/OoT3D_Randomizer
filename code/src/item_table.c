...
static ItemRow rItemTable[] = {
    ...
    [GI_UNBOTTLED_BIG_POE]  = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9080,   0x0084, 0xFF, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_UnbottledBigPoe, -1, -1), // Unbottled spirit for Big Poe Shuffle
};
// clang-format on
