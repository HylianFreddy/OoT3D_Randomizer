...
The second model, if present, will face the camera by default (because it's a 2D billboard like the fairy orb in the bottle).
Exceptions to this can be added in Model_UpdateMatrix.
*/
...
static ItemRow rItemTable[] = {
    ...
    [GI_SCALE_SILVER]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x53, 0x00CD,   0x00DB, 0x00, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_None, -1, -1), // Silver Scale
    [GI_SCALE_GOLD]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x54, 0x00CE,   0x00DB, 0x01, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_None, -1, -1), // Golden Scale
    ...
    [GI_SKULL_TOKEN]        = ITEM_ROW(0x5B, CHEST_SKULL,     0x71, 0x00B4,   0x0024, 0x02, 0xFF, 0x03, 0x00,   0xFF, ItemUpgrade_TokenToRupee, ItemEffect_None, -1, -1), // Gold Skulltula Token
    ...
    [GI_BLUE_FIRE]          = ITEM_ROW(0x53, CHEST_MAJOR,     0x1C, 0x005D,   0x0173, 0x01, 0x00, 0x00, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_None, -1, -1), // Blue Fire (Refill)
    ...
    [GI_BIG_POE]            = ITEM_ROW(0x53, CHEST_MAJOR,     0x1E, 0x00F9,   0x019A, 0x01, 0x00, 0x00, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_None, -1, -1), // Big Poe (Refill)
    ...
    [GI_BULLET_BAG_50]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x006C,   0x017B, 0x00, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_GiveUpgrade, 3, 5), // Bullet Bag (50)
    ...
    [GI_SHADOW_TSMALL_KEY]  = ITEM_ROW(0x53, CHEST_SMALL_KEY, 0x41, 0x09F2,   0x0079, 0x00, 0xFF, 0xFF, 0xFF,   0x03, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_SHADOW_TEMPLE, -1), // Shadow Temple Small Key
    ...
    [GI_TYCOON_WALLET]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x09F7,   0x00D1, 0x00, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, ItemEffect_GiveTycoonWallet, 3, -1), // Tycoon's Wallet
...
//  [GI_TRIFORCE_PIECE]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9003,   0x0193, 0x00, 0xFF, 0xFF, 0xFF,   0xFF, ItemUpgrade_None, give_triforce_piece,        -1, -1), // Triforce piece
    ...
    [GI_SOUL_POE]           = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9450,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_POE,                   -1),
    [GI_SOUL_OCTOROK]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9451,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_OCTOROK,               -1),
    [GI_SOUL_WALLMASTER]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9452,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_WALLMASTER,            -1),
    [GI_SOUL_KEESE]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9453,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_KEESE,                 -1),
    [GI_SOUL_TEKTITE]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9454,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_TEKTITE,               -1),
    [GI_SOUL_LEEVER]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9455,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_LEEVER,                -1),
    [GI_SOUL_PEAHAT]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9456,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_PEAHAT,                -1),
    [GI_SOUL_LIZALFOS]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9457,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_LIZALFOS,              -1),
    [GI_SOUL_SHABOM]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9458,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SHABOM,                -1),
    [GI_SOUL_BIRI_BARI]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9459,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BIRI_BARI,             -1),
    [GI_SOUL_TAILPASARAN]   = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x945A,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_TAILPASARAN,           -1),
    [GI_SOUL_SKULLTULA]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x945B,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SKULLTULA,             -1),
    [GI_SOUL_TORCH_SLUG]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x945C,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_TORCH_SLUG,            -1),
    [GI_SOUL_STINGER]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x945D,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_STINGER,               -1),
    [GI_SOUL_MOBLIN]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x945E,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_MOBLIN,                -1),
    [GI_SOUL_ARMOS]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x945F,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_ARMOS,                 -1),
    [GI_SOUL_DEKU_BABA]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9460,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DEKU_BABA,             -1),
    [GI_SOUL_BUBBLE]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9461,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BUBBLE,                -1),
    [GI_SOUL_FLYING_POT]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9462,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FLYING_POT,            -1),
    [GI_SOUL_FLYING_TILE]   = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9463,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FLYING_TILE,           -1),
    [GI_SOUL_BEAMOS]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9464,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BEAMOS,                -1),
    [GI_SOUL_FLOORMASTER]   = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9465,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FLOORMASTER,           -1),
    [GI_SOUL_REDEAD_GIBDO]  = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9466,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_REDEAD_GIBDO,          -1),
    [GI_SOUL_SHELL_BLADE]   = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9467,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SHELL_BLADE,           -1),
    [GI_SOUL_LIKE_LIKE]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9468,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_LIKE_LIKE,             -1),
    [GI_SOUL_TENTACLE]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9469,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_TENTACLE,              -1),
    [GI_SOUL_ANUBIS]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946A,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_ANUBIS,                -1),
    [GI_SOUL_SPIKE]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946B,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SPIKE,                 -1),
    [GI_SOUL_SKULL_KID]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946C,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_SKULL_KID,             -1),
    [GI_SOUL_FREEZARD]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946D,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FREEZARD,              -1),
    [GI_SOUL_DEKU_SCRUB]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946E,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DEKU_SCRUB,            -1),
    [GI_SOUL_WOLFOS]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x946F,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_WOLFOS,                -1),
    [GI_SOUL_STALCHILD]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9470,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_STALCHILD,             -1),
    [GI_SOUL_GUAY]          = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9471,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GUAY,                  -1),
    [GI_SOUL_DOOR_MIMIC]    = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9472,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DOOR_MIMIC,            -1),
    [GI_SOUL_STALFOS]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9473,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_STALFOS,               -1),
    [GI_SOUL_DARK_LINK]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9474,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DARK_LINK,             -1),
    [GI_SOUL_FLARE_DANCER]  = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9475,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_FLARE_DANCER,          -1),
    [GI_SOUL_DEAD_HAND]     = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9476,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DEAD_HAND,             -1),
    [GI_SOUL_GERUDO]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9477,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GERUDO,                -1),
    [GI_SOUL_GOHMA]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9478,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GOHMA,                 -1),
    [GI_SOUL_DODONGO]       = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9479,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_DODONGO,               -1),
    [GI_SOUL_BARINADE]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947A,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BARINADE,              -1),
    [GI_SOUL_PHANTOM_GANON] = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947B,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_PHANTOM_GANON,         -1),
    [GI_SOUL_VOLVAGIA]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947C,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_VOLVAGIA,              -1),
    [GI_SOUL_MORPHA]        = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947D,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_MORPHA,                -1),
    [GI_SOUL_BONGO_BONGO]   = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947E,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_BONGO_BONGO,           -1),
    [GI_SOUL_TWINROVA]      = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x947F,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_TWINROVA,              -1),
    [GI_SOUL_GANON]         = ITEM_ROW(0x53, CHEST_MAJOR,     0x41, 0x9480,   0x00E4, 0x00, 0xFF, 0x01, 0x00,   0xFF, ItemUpgrade_None, ItemEffect_EnemySoul, SOUL_GANON,                 -1),
