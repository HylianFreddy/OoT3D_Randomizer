    ...
    do
    {
        ...
        if (chosen) {
            if(pressed & (BUTTON_B | BUTTON_A)) // unselect option
            {
                ...
                chosen = 0;
                if (rInputCtx.cur.r && selected == Entrance_Select_Menu_CsIdx) {
            ...
            else if (pressed & (PAD_UP | PAD_DOWN)) // change selected value
            {
                if (selected == Entrance_Select_Menu_CsIdx) {
                    ...
                    if(cutsceneIndex > 15){
                        cutsceneIndex = (rInputCtx.cur.r ? -2 : -1);
                    }
                    if(cutsceneIndex < (rInputCtx.cur.r ? -2 : -1)) {
                        cutsceneIndex = 15;
                    }
                }
            }
            ...
            if(pressed & BUTTON_A) // select option
            {
                if (manualSelection && selected == Entrance_Select_Menu_Etcs) {
                    ...
                    chosenTime++;
                    chosenTime %= 5;
                    if (rInputCtx.cur.r && chosenTime != 0){
                    ...
                    EntranceWarp(entranceIndex, chosenAge, cutsceneIndex, chosenTime, rInputCtx.cur.r);
                    menuOpen = false;
                }
            }
