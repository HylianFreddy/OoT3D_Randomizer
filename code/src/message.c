    ...
    if (ctrl > TEXT_CTRL_0x2F) {
        switch (ctrl) {
            case TEXT_CTRL_TRIFORCE_PIECE_COUNT:
                snprintf(str, MESSAGE_MAX_CUSTOM_STRING_SIZE, "%d", gExtSaveData.triforcePieces);
                break;
            case TEXT_CTRL_DEKU_SHIELD_COUNT:
                snprintf(str, MESSAGE_MAX_CUSTOM_STRING_SIZE, "%d", gExtSaveData.dekuShieldsCount);
                break;
            case TEXT_CTRL_HYLIAN_SHIELD_COUNT:
                snprintf(str, MESSAGE_MAX_CUSTOM_STRING_SIZE, "%d", gExtSaveData.hylianShieldsCount);
                break;
            default:
                break;
        }
