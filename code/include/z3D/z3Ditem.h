...
typedef enum {
    ...
    /* 0xE4 */  GI_SOUL_LEEVER,
    /* 0xE5 */  GI_SOUL_PEAHAT,
    /* 0xE6 */  GI_SOUL_LIZALFOS_DINOLFOS,
    /* 0xE7 */  GI_SOUL_SHABOM,
    ...
    /* 0xF2 */  GI_SOUL_FLYING_FLOOR_TILE,
    /* 0xF3 */  GI_SOUL_BEAMOS,
    /* 0xF4 */  GI_SOUL_FLOORMASTER,
    /* 0xF5 */  GI_SOUL_REDEAD_GIBDO,
    /* 0xF6 */  GI_SOUL_SHELL_BLADE,
    /* 0xF7 */  GI_SOUL_LIKE_LIKE,
    /* 0xF8 */  GI_SOUL_PARASITIC_TENTACLE,
    /* 0xF9 */  GI_SOUL_ANUBIS,
    /* 0xFA */  GI_SOUL_SKULL_KID,
    /* 0xFB */  GI_SOUL_FREEZARD,
    /* 0xFC */  GI_SOUL_DEKU_SCRUB,
    /* 0xFD */  GI_SOUL_WOLFOS,
    /* 0xFE */  GI_SOUL_STALCHILD,
    /* 0xFF */  GI_SOUL_GUAY,
    /* 0x100 */ GI_SOUL_DOOR_MIMIC,
    /* 0x101 */ GI_SOUL_STALFOS,
    /* 0x102 */ GI_SOUL_DARK_LINK,
    /* 0x103 */ GI_SOUL_FLARE_DANCER,
    /* 0x104 */ GI_SOUL_DEAD_HAND,
    /* 0x105 */ GI_SOUL_BIG_OCTO,
