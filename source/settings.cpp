...
Option TogglePlayMusic    = Option::U8("Play Music",           {"Off", "On", "Partial"},                                    {""},                     OptionCategory::Cosmetic, 1);
Option TogglePlaySFX      = Option::U8("Play Sound Effects",   {"Off", "On (Vanilla)", "On (Randomized)"},                  {""},                     OptionCategory::Cosmetic, 1);
Option NaviNotifications  = Option::U8("Navi Notifications",   {"Silenced", "Constant"},                                    {naviNotificationsDesc},  OptionCategory::Cosmetic, NAVINOTIFS_SILENCED);
