...
typedef enum {
    ...
    ITEM_SOUL_DEKU_BABA,
    ITEM_SOUL_BUBBLE,
    ITEM_SOUL_FLYING_POT,        // remove?
    ITEM_SOUL_FLYING_FLOOR_TILE, // remove?
    ITEM_SOUL_BEAMOS,
    ITEM_SOUL_FLOORMASTER,
    ITEM_SOUL_REDEAD_GIBDO,
    ITEM_SOUL_SHELL_BLADE,
    ITEM_SOUL_LIKE_LIKE,
    ITEM_SOUL_PARASITIC_TENTACLE, // merge with barinade?
    ITEM_SOUL_ANUBIS,
    ITEM_SOUL_SKULL_KID, // not a monster?
    ITEM_SOUL_FREEZARD,
