...
void InitEnemyLocations(void) {
    ...
    if (Dungeon::WaterTemple.IsVanilla()) {
        ...
        enemyLocations[5][0][8][2]       = EnemyLocation(LocType::UNDERWATER,     ENEMY_SHELL_BLADE);
        enemyLocations[5][0][8][3]       = EnemyLocation(LocType::UNDERWATER,     ENEMY_SHELL_BLADE);
        ...
        enemyLocations[5][0][12][0]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_SHELL_BLADE);
        enemyLocations[5][0][12][3]      = EnemyLocation(LocType::ABOVE_WATER,    ENEMY_TEKTITE_BLUE);
        enemyLocations[5][0][12][4]      = EnemyLocation(LocType::ABOVE_GROUND,   ENEMY_TEKTITE_BLUE);
        enemyLocations[5][0][12][5]      = EnemyLocation(LocType::ABOVE_WATER,    ENEMY_TEKTITE_BLUE);
        enemyLocations[5][0][12][6]      = EnemyLocation(LocType::ABOVE_GROUND,   ENEMY_TEKTITE_BLUE);
        enemyLocations[5][0][12][7]      = EnemyLocation(LocType::ABOVE_WATER,    ENEMY_TEKTITE_BLUE);
        enemyLocations[5][0][12][8]      = EnemyLocation(LocType::ABOVE_WATER,    ENEMY_TEKTITE_BLUE);
        enemyLocations[5][0][13][0xFF]   = EnemyLocation(LocType::ABOVE_GROUND,   ENEMY_DARK_LINK);
        enemyLocations[5][0][14][0]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[5][0][14][1]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[5][0][14][2]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[5][0][14][3]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[5][0][14][4]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
    ...
    if (Dungeon::JabuJabusBelly.IsMQ()) {
        ...
        enemyLocations[2][0][1][16]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        ...
        enemyLocations[2][0][13][5]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[2][0][13][6]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[2][0][14][0]      = EnemyLocation(LocType::ABOVE_GROUND,   ENEMY_STINGER_FLOOR);
        enemyLocations[2][0][14][1]      = EnemyLocation(LocType::ABOVE_GROUND,   ENEMY_STINGER_FLOOR);
    ...
    if (Dungeon::GerudoTrainingGrounds.IsMQ()) {
        ...
        enemyLocations[11][0][9][0]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
        enemyLocations[11][0][9][1]      = EnemyLocation(LocType::UNDERWATER,     ENEMY_STINGER_WATER);
