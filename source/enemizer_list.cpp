...
std::vector<EnemyType> enemyTypes = {
    ...
    EnemyType("Skulltula (Big)",      ACTOR_SKULLTULA,          0x0001, canKillSkulltula,     {LocationType::ABOVE_GROUND, LocationType::ABOVE_VOID, LocationType::UNDERWATER}),
    ...
    EnemyType("Mad Scrub",            ACTOR_MAD_SCRUB,          0x0300, canKillScrub,         {LocationType::ABOVE_GROUND, LocationType::UNDERWATER}), // volley count?
