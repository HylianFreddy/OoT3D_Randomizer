...
std::vector<EnemyType> enemyTypes = {
    ...
    EnemyType("Stalfos",              ACTOR_STALFOS,            0x0002, canKillStalfos,       {LocationType::ABOVE_GROUND}),
    EnemyType("Stalfos",              ACTOR_STALFOS,            0x0003, canKillStalfos,       {LocationType::ABOVE_GROUND}),
    ...
    EnemyType("Keese",                ACTOR_KEESE,              0x0002, canKillKeese,         {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND, LocationType::ABOVE_WATER}),
    EnemyType("Fire Keese",           ACTOR_KEESE,              0x0001, canKillKeese,         {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND, LocationType::ABOVE_WATER}),
    EnemyType("Ice Keese",            ACTOR_KEESE,              0x0004, canKillKeese,         {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND, LocationType::ABOVE_WATER}),
    ...
    EnemyType("Lizalfos",             ACTOR_LIZALFOS,           0xFF80, canKillLizalfos,      {LocationType::ABOVE_GROUND}),
    EnemyType("Lizalfos",             ACTOR_LIZALFOS,           0xFFFF, canKillLizalfos,      {LocationType::ABOVE_GROUND}),
    EnemyType("Dinolfos",             ACTOR_LIZALFOS,           0xFFFE, canKillLizalfos,      {LocationType::ABOVE_GROUND}),
    EnemyType("Gohma Larva",          ACTOR_GOHMA_LARVA,        0x0007, canKillGohmaLarva,    {LocationType::UNDERWATER, LocationType::ABOVE_GROUND}),
    EnemyType("Shabom",               ACTOR_SHABOM,             0x0000, canKillShabom,        {LocationType::UNDERWATER, LocationType::ABOVE_GROUND, LocationType::ABOVE_WATER}),
    EnemyType("Baby Dodongo",         ACTOR_BABY_DODONGO,       0x0000, canKillBabyDodongo,   {LocationType::ABOVE_GROUND}),
    EnemyType("Biri",                 ACTOR_BIRI,               0xFFFF, canKillBiri,          {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND, LocationType::ABOVE_WATER}),
    EnemyType("Tailpasaran",          ACTOR_TAILPASARAN,        0xFFFF, canKillTailsparan,    {LocationType::ABOVE_GROUND}),
    EnemyType("Skulltula",            ACTOR_SKULLTULA,          0x0000, canKillSkulltula,     {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND}),
    EnemyType("Skulltula (Big)",      ACTOR_SKULLTULA,          0x0001, canKillSkulltula,     {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND}),
    ...
    EnemyType("Deku Baba (Big)",      ACTOR_DEKU_BABA,          0x0001, canKillDekuBaba,      {LocationType::ABOVE_GROUND}),
    EnemyType("Mad Scrub",            ACTOR_MAD_SCRUB,          0x0300, canKillScrub,         {LocationType::UNDERWATER}), // volley count?
    EnemyType("Bari",                 ACTOR_BARI,               0xFFFF, canKillBiri,          {LocationType::UNDERWATER, LocationType::ABOVE_GROUND}),
    EnemyType("Bubble (Blue)",        ACTOR_BUBBLE,             0xFFFF, canKillBlueBubble,    {LocationType::ABOVE_GROUND}),
    EnemyType("Bubble (Fire)",        ACTOR_BUBBLE,             0xFFFE, canKillBlueBubble,    {LocationType::ABOVE_GROUND}),
    ...
    EnemyType("Redead",               ACTOR_REDEAD,             0x7F01, canKillRedead,        {LocationType::ABOVE_GROUND}), // crouching?
    ...
    // EnemyType("Skullwalltula",        ACTOR_SKULLWALLTULA,      0x0000, canKillSkullwalltula, {LocationType::UNDERWATER}),
    EnemyType("Flare Dancer",         ACTOR_FLARE_DANCER,       0x0000, canKillFlareDancer,   {LocationType::ABOVE_GROUND}),
    EnemyType("Shell Blade",          ACTOR_SHELL_BLADE,        0x0000, canKillShellBlade,    {LocationType::UNDERWATER, LocationType::ABOVE_GROUND}),
    ...
    EnemyType("Spike EnemyType",          ACTOR_SPIKE,              0x0000, canKillSpikeEnemy,    {LocationType::ABOVE_GROUND}),
    EnemyType("Anubis Spawner",       ACTOR_ANUBIS_SPAWNER,     0x0003, canKillAnubis,        {LocationType::ABOVE_VOID}),
    EnemyType("Iron Knuckle (Black)", ACTOR_IRON_KNUCKLE,       0xFF02, canKillIronKnuckle,   {LocationType::ABOVE_GROUND}),
    EnemyType("Iron Knuckle (White)", ACTOR_IRON_KNUCKLE,       0xFF03, canKillIronKnuckle,   {LocationType::ABOVE_GROUND}),
    ...
    EnemyType("Freezard",             ACTOR_FREEZARD,           0x0000, canKillFreezard,      {LocationType::ABOVE_GROUND}),
    EnemyType("Freezard",             ACTOR_FREEZARD,           0xFFFF, canKillFreezard,      {LocationType::ABOVE_GROUND}),
    EnemyType("Stinger",              ACTOR_STINGER_WATER,      0x0000, canKillStinger,       {LocationType::UNDERWATER}),
    ...
    EnemyType("Stalchild",            ACTOR_STALCHILD,          0x0000, canKillStalchild,     {LocationType::ABOVE_GROUND}),
    EnemyType("Stalchild (Big)",      ACTOR_STALCHILD,          0x0005, canKillStalchild,     {LocationType::ABOVE_GROUND}),
    EnemyType("Guay",                 ACTOR_GUAY,               0x0000, canKillGuay,          {LocationType::UNDERWATER, LocationType::ABOVE_VOID, LocationType::ABOVE_GROUND, LocationType::ABOVE_WATER}),
